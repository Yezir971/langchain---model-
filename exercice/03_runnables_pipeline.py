...
L'approche moderne utilise LCEL (runnables) pour composer des pipelines.
    ...
    error_prompt = ChatPromptTemplate.from_messages([
        SystemMessage(content="Tu es un expert en gestion d'erreur, liste lles pièges potentiel sous forme de puce."),
        HumanMessage(content="Donne 3 pièges potentiels, Résumé : {summary}")
    ])
    ...
    error_chain = error_prompt | chat | to_str
